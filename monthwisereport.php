<?php
    ...
    if(isset($_POST['show_report'])){
        $start_date = $_POST['startdate']."-01";  // $_POST['year']."-01-01"+
                    ...
                    <div class="container-fluid">
                        <form method="post">
                            <div class="form-group">
                                ...
                                <input type="month" class="form-control" name="startdate" placeholder="dd-mm-yyyy" required >
                            </div>
                            <div class="form-group">
                                <label for=""> End Month</label>
                                <input type="month" class="form-control" name="enddate" placeholder="Item name here" required>
                            </div>
